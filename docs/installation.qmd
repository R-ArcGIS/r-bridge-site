...
Before installing, we recommend that you have the newest version of R installed. At minimum, we suggest you use R version 4.3 or higher. You can install the latest version of R from [CRAN](https://cloud.r-project.org/).
...
<img src="shared/images/arcgisbinding-installer-homedir.png"
style="width:50.0%" data-fig-align="center"
data-fig-alt="A screenshot of the Options window with the Detected R home directories drop-down in the R-ArcGIS Support section highlighted." />
...
<img src="shared/images/arcgisbinding-installer-internet.png"
style="width:50.0%" data-fig-align="center"
data-fig-alt="A screenshot of the Options window with the ArcGIS R integration package installation drop-down in the R-ArcGIS Support section highlighted, showing the Install package from the internet option." />
...
<img src="shared/images/arcgisbinding-installer-complete.png"
style="width:50.0%" data-fig-align="center"
data-fig-alt="A screenshot of the Options window with the completed installation message highlighted, reading Installed arcgisbinding package version 1.0.1.306." />
