...
![](../shared/images/read-data/usa-cities-server.png)

This reveals the Feature Layer of interest. 

![](../shared/images/read-data/usa-cities-layer.png){width=70%}
