...
Items in ArcGIS Online and ArcGIS Enterprise can be unshared (accessible only to the item owner) or shared to groups, your organization, or everyone (<span style="display:inline-block; width: 179px;"><img src="../shared/images/sharing-public.png"/></span>). [Learn more about Sharing here.](https://doc.arcgis.com/en/arcgis-online/share-maps/share-items.htm) Read and write access to an item is controlled by the owner-specified sharing level, organizational security settings, and the accessing user's [privileges](https://doc.arcgis.com/en/arcgis-online/administer/roles.htm).
:::
...
<div style="width:400px;">
  <img src="../shared/images/content-app.png" width=100% />
</div>
...
<div style="width:400px;">
  <img src="../shared/images/new-item.png" width=100% />
</div>
...
<div style="width:400px;">
  <img src="../shared/images/credentials.png" width=100% />
</div>
...
<div style="width:400px;">
  <img src="../shared/images/oauth-sign-in.png" width=100% />
</div>
...
<div style="width:400px;">
  <img src="../shared/images/oauth-code.png" width=100% />
</div>
