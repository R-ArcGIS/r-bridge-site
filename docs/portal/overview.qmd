...
:::{.callout-caution}
If you have not yet set up your R environment for authentication, see the [Authentication section](/authentication/overview). Ensure that the environment variables. If you are using ArcGIS Enterprise, ensure that `ARCGIS_HOST` is properly set.
:::
